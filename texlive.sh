...
# for documentation
tlmgr install xcolor enumitem  booktabs  enumitem fancyvrb refstyle subfig url underscore metalogo iwona graphics-def tools caption ltxmisc titlesec hyperref inconsolata zapfding dejavu
