...
With |vargreek-shape=TeX| (default),
...
That is, no remapping occurs of the characters/glyphs, only in the definitions of the control sequences \cs{phi} and \cs{epsilon} themselves.
