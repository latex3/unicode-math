...
\subsubsection{Control over maths styles}

Exact control over maths styles can be somewhat involved.
...
And now the trick.
If a particular math style is not defined in the font, fall back onto the lower-base plane (i.e., upright) glyphs.
...
What is the difference between a style and a legacy alphabet?
